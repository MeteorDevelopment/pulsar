...
public class PropertyTypes {
    ...
    public static final PropertyType<IColor> COLOR_TYPE = add(new PropertyType.Builder<>("Color", () -> IColor.WHITE)
    ...
    public static final PropertyType<Color4> COLOR4_TYPE = add(new PropertyType.Builder<>("Color4", () -> new Color4(IColor.WHITE))
