...
public class PtsLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "NUMBER", "STRING", "HEX_COLOR", "RGB_COLOR", "PX", "IDENTIFIER", 
			"OPENING_BRACE", "CLOSING_BRACE", "OPENING_BRACKET", "CLOSING_BRACKET", 
			"COMMA", "SEMICOLON", "BANG", "COMMENT", "LINE_COMMENT", "WS", "UNKNOWN", 
			"INT", "HEX"
		};
	}
	...
	public PtsLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "Pts.g4"; }
